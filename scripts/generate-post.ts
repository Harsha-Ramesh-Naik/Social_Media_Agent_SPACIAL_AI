...
async function invokeGraph() {
  // Use the article URL configured in .env, falling back to a default URL if not set.
  const link = process.env.SOURCE_URL || "https://blog.langchain.dev/customers-appfolio/";
