...
export const GeneratePostAnnotation = Annotation.Root({
  ...
  /**
   * LinkedIn-specific version of the generated post.
   */
  ...
  /**
   * Twitter/X-specific version of the generated post.
   */
  ...
  /**
   * Instagram-specific caption for the generated post.
   */
  instagramPost: Annotation<string>({
    reducer: (_state, update) => update,
    default: () => "",
  }),
  /**
